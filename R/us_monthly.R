...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\us_ft_monthly.csv", 
          row.names=F)
...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\us_lt_monthly.csv", 
          row.names=F)
...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\us_mt_monthly.csv", 
          row.names=F)
