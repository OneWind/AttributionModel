...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\uk_ft_monthly.csv", 
          row.names=F)
...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\uk_lt_monthly.csv", 
          row.names=F)
...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\uk_mt_monthly.csv", 
          row.names=F)
