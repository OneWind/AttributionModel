...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\ca_ft_monthly.csv", 
          row.names=F)
...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\ca_lt_monthly.csv", 
          row.names=F)
...
write.csv(monthly, 
          file="\\\\corpshares\\Analytics\\Feng\\AttrNew\\results\\ca_mt_monthly.csv", 
          row.names=F)
