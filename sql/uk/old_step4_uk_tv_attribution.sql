...
alter table a.feng_uk_visit_tv_signup add tvweights_ft_decay float
go
alter table a.feng_uk_visit_tv_signup add tvweights_lt_decay float
go
alter table a.feng_uk_visit_tv_signup add tvweights_mt_decay float
go
alter table a.feng_uk_visit_tv_signup add firsttouchweights_update_decay float
go
alter table a.feng_uk_visit_tv_signup add lasttouchweights_update_decay float
go
alter table a.feng_uk_visit_tv_signup add multitouchweights_update_decay float
go

alter table a.feng_uk_visit_tv_signup add tvweights_ft_trump float
go
alter table a.feng_uk_visit_tv_signup add tvweights_lt_trump float
go
alter table a.feng_uk_visit_tv_signup add tvweights_mt_trump float
go
alter table a.feng_uk_visit_tv_signup add firsttouchweights_update_trump float
go
alter table a.feng_uk_visit_tv_signup add lasttouchweights_update_trump float
go
alter table a.feng_uk_visit_tv_signup add multitouchweights_update_trump float
go

alter table a.feng_uk_visit_tv_signup add tvweights_ft_decay_invisit float
go
alter table a.feng_uk_visit_tv_signup add tvweights_lt_decay_invisit float
go
alter table a.feng_uk_visit_tv_signup add tvweights_mt_decay_invisit float
go
alter table a.feng_uk_visit_tv_signup add firsttouchweights_update_decay_invisit float
go
alter table a.feng_uk_visit_tv_signup add lasttouchweights_update_decay_invisit float
go
alter table a.feng_uk_visit_tv_signup add multitouchweights_update_decay_invisit float
go

alter table a.feng_uk_visit_tv_signup add tvweights_ft_trump_invisit float
go
alter table a.feng_uk_visit_tv_signup add tvweights_lt_trump_invisit float
go
alter table a.feng_uk_visit_tv_signup add tvweights_mt_trump_invisit float
go
alter table a.feng_uk_visit_tv_signup add firsttouchweights_update_trump_invisit float
go
alter table a.feng_uk_visit_tv_signup add lasttouchweights_update_trump_invisit float
go
alter table a.feng_uk_visit_tv_signup add multitouchweights_update_trump_invisit float
go
...
--alter table a.feng_uk_visit_tv_signup add channel varchar(100)
--go
