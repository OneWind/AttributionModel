...
from (select * from a.feng_uk_factvisits
...
select top 100 servertimemst, ucdmid, freetrialorders, hardofferorders, signupcreatedate
     , visitnumber, firsttouchweights, lasttouchweights, multitouchweights
from a.feng_visitandsignup
where trunc(servertimemst) = trunc(signupcreatedate)
go
