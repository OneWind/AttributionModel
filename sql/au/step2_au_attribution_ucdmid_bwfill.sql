...
-- date upper end: '2015-07-01'


select dropif('a', 'feng_au_ucdmidpool')
go

select distinct tb1.ucdmid
into a.feng_au_ucdmidpool
from a.feng_au_factvisits_ucdmid_bwfill tb1
...
--------------------------------------------------------------------------------
select dropif('a', 'feng_au_factvisitsample')
go
...
--     , dnaorders
     ...
     , rdnum
into a.feng_au_factvisitsample
from (select * from a.feng_au_factvisits_ucdmid_bwfill
      where ucdmid in (select ucdmid from a.feng_au_ucdmidpool))
go
...
--------------------------------------------------------------------------------
select dropif('a', 'feng_au_visitandsignup_tmp0')
go
...
into a.feng_au_visitandsignup_tmp0
from a.feng_au_factvisitsample tb1
...
select dropif('a', 'feng_au_sutmp')
go

select ucdmid, signupcreatedate
into a.feng_au_sutmp
from a.feng_au_visitandsignup_tmp0
where orderid = signupordernumber
go

select dropif('a', 'feng_au_visitandsignup_tmp1')
go

select tb1.*
into a.feng_au_visitandsignup_tmp1
from a.feng_au_visitandsignup_tmp0 tb1
    join a.feng_au_sutmp tb2 on (tb1.ucdmid = tb2.ucdmid and tb1.signupcreatedate = tb2.signupcreatedate)
go
...
--------------------------------------------------------------------------------
select dropif('a', 'feng_au_visitandsignup_tmp2')
go

select ucdmid, servertimemst, autimezone, min(signupcreatedate) signupcreatedate, 
       subchannel, new_freetrialorders, new_hardofferorders, 
--       new_dnaorders,
       visitorid, rdnum,
       devicegroupdescription, browserdescription, operatingsystemdescription
into a.feng_au_visitandsignup_tmp2
from a.feng_au_visitandsignup_tmp1
group by ucdmid, servertimemst, autimezone, subchannel, 
...
--------------------------------------------------------------------------------
select dropif('a', 'feng_au_visitandsignup')
go

select tb1.*, tb2.maxvisitnumber
into a.feng_au_visitandsignup
from a.feng_au_visitandsignup_tmp3 tb1
    join a.feng_au_maxvisitnumber tb2 
...
--------------------------------------------------------------------------------
alter table a.feng_au_visitandsignup add firsttouchweights float
go
alter table a.feng_au_visitandsignup add lasttouchweights float
go
alter table a.feng_au_visitandsignup add multitouchweights float
go

update a.feng_au_visitandsignup
set firsttouchweights = case when visitnumber = 1 then 1 else 0 end 
from a.feng_au_visitandsignup
go
update a.feng_au_visitandsignup
...
--------------------------------------------------------------------------------
select dropif('a', 'feng_au_attribution_3touches')
go
...
into a.feng_au_attribution_3touches
from a.feng_au_visitandsignup
group by subchannel
go

--select * from a.feng_au_attribution_3touches
--go
--------------------------------------------------------------------------------
-- freetrial orders and hardoffer orders group by visitnumber                 --
--------------------------------------------------------------------------------
select dropif('a', 'feng_au_orderbyvisitnumber')
go
...
into a.feng_au_orderbyvisitnumber
from a.feng_au_visitandsignup
...
--select * from a.feng_au_orderbyvisitnumber
--go
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
...
--    join a.feng_au_visitandsignup tb2
...
select dropif('a', 'feng_au_ft_visitandsignup')
go

select tb1.*
into a.feng_au_ft_visitandsignup
from a.feng_au_visitandsignup tb1
...
select datediff(day, tb1.servertimemst, tb2.servertimemst)
     , count(*) cnt
from a.feng_au_ft_visitandsignup tb1
    join a.feng_au_ft_visitandsignup tb2
        on (tb1.ucdmid = tb2.ucdmid
            and tb1.signupcreatedate = tb2.signupcreatedate
            and tb1.visitnumber = 1
            and tb2.visitnumber = 5)
...
select dropif('a', 'feng_au_ho_visitandsignup')
go

select tb1.*
into a.feng_au_ho_visitandsignup
from a.feng_au_visitandsignup tb1
    join (select ucdmid, signupcreatedate
          from a.feng_au_visitandsignup
          group by ucdmid, signupcreatedate
...
select datediff(day, tb1.servertimemst, tb2.servertimemst)
     , count(*) cnt
from a.feng_au_ho_visitandsignup tb1
    join a.feng_au_ho_visitandsignup tb2
        on (tb1.ucdmid = tb2.ucdmid
            and tb1.signupcreatedate = tb2.signupcreatedate
            and tb1.visitnumber = 1
            and tb2.visitnumber = 5)
